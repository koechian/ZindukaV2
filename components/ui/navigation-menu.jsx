...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 font-medium transition-colors hover:bg-[#C8F168] hover:text-neutral-900 focus:bg-[#C8F168] focus:text-neutral-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-[#C8F168] data-[state=open]:bg-[#C8F168] dark:bg-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[active]:bg-[#C8F168] dark:data-[state=open]:bg-[#C8F168]"
);
